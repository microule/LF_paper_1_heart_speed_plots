# -*- coding: utf-8 -*-
"""
Created on Wed Apr 20 17:12:36 2016

@author: Sara Madaan
"""


## this file plots the speed plots for both heart beats together and cleans them up for the poster
#. It also plots the average speed 
...
x_ticks = np.arange(0.05,np.around(size_speed_arr_new[0]/90,decimals=1),0.1)
...
#plot the figures
fig, ax = plt.subplots()
ax.plot(speed_arr_new_2[:,0]/90,speed_arr_new_1[:,1],color='blue',lw = 6,label = 'Track 3')
ax.plot(speed_arr_new_2[:,0]/90,speed_arr_new_1[:,2],color='red',lw = 6,label = 'Track 4')
ax.plot(speed_arr_new_2[:,0]/90,speed_arr_new_1[:,3],color='chocolate',lw = 6,label = 'Track 5')
...
ave_new_3 = np.copy(ave_new_1) 
ave_new_3[43:,1] = ave_new_2[43:,1]     
    
#plot the figures
y_ticks = np.arange(0,4.5,0.5)    
    
fig, ax = plt.subplots()
ax.plot(ave_new_3[:,0]/90,ave_new_3[:,1],color='black',lw = 6,label = 'Avg_heartbeat_1')
ax.xaxis.set_ticks( x_ticks)
