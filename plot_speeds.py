...
## keeps the time axis same for both plots. It also plots the average speed 
...
speed_arr_new = speed_arr[0:92,:]  
size_speed_arr_new =  np.asarray(np.shape(speed_arr_new))

#%% plot the figures
fig, ax = plt.subplots()

ax.plot(speed_arr_new[:,0],speed_arr_new[:,1],color='blue',lw = 6,label = 'Track 1')
...
ax.plot(speed_arr_new[:,0],speed_arr_new[:,3],color='red',lw = 6,label = 'Track 3')
ax.plot(speed_arr_new[:,0],speed_arr_new[:,4],color='cyan',lw = 6,label = 'Track 4')
ax.plot(speed_arr_new[:,0],speed_arr_new[:,5],color='magenta',lw = 6,label = 'Track 5')
ax.plot(speed_arr_new[:,0],speed_arr_new[:,6],color='yellow',lw = 6,label = 'Track 6')
ax.plot(speed_arr_new[:,0],speed_arr_new[:,7],color='black',lw = 6,label = 'Track 7')
ax.plot(speed_arr_new[:,0],speed_arr_new[:,8],color='darkorange',lw = 6,label = 'Track 8')    
ax.plot(speed_arr_new[:,0],speed_arr_new[:,9],color='darkgreen',lw = 6,label = 'Track 9')
ax.plot(speed_arr_new[:,0],speed_arr_new[:,10],color='chocolate',lw = 6,label = 'Track 10')
ax.plot(speed_arr_new[:,0],speed_arr_new[:,11],color='hotpink',lw = 6,label = 'Track 11')
ax.plot(speed_arr_new[:,0],speed_arr_new[:,12],color='yellowgreen',lw = 6,label = 'Track 12')
ax.xaxis.set_ticks( np.arange(1,size_speed_arr_new[0],5))
...
ax.plot(speed_arr_new_1[:,0]/90,speed_arr_new_1[:,1],color='blue',lw = 6,label = 'Track 3')
ax.plot(speed_arr_new_1[:,0]/90,speed_arr_new_1[:,2],color='red',lw = 6,label = 'Track 4')
ax.plot(speed_arr_new_1[:,0]/90,speed_arr_new_1[:,3],color='chocolate',lw = 6,label = 'Track 5')

ax.xaxis.set_ticks( np.arange(0,size_speed_arr_new[0]/90,5/90))
...
ax.plot(speed_arr_new_2[:,0]/90,speed_arr_new_2[:,1],color='black',lw = 6,label = 'Track 6')
ax.plot(speed_arr_new_2[:,0]/90,speed_arr_new_2[:,2],color='brown',lw = 6,label = 'Track 7')
ax.plot(speed_arr_new_2[:,0]/90,speed_arr_new_2[:,3],color='darkgreen',lw = 6,label = 'Track 8')
ax.plot(speed_arr_new_2[:,0]/90,speed_arr_new_2[:,4],color='hotpink',lw = 6,label = 'Track 9')
...
ax.plot(ave_new_1[:,0]/90,ave_new_1[:,1],color='black',lw = 6,label = 'Avg_heartbeat_1')
ax.xaxis.set_ticks( np.arange(0,size_speed_arr_new[0]/90,0.05))
...
ax.plot(ave_new_2[:,0]/90,ave_new_2[:,1],color='black',lw = 6,label = 'Avg_heartbeat_1')
ax.xaxis.set_ticks( np.arange(0,size_speed_arr_new[0]/90,5/90))
